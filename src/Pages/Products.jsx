  ...
  const mobileView = (
    <div className="min-h-screen">
      ...
      {loading ? (
        ...
        <div>
          <div className="filterOptions w-full pt-[30vw] px-[3vw] flex justify-between items-center font-[font2] text-[vw]">
            <div className="flex items-center gap-[5.5vw]">
              <i className="ri-equalizer-2-line text-[6vw]"></i>
              <h4 className="uppercase text-[3.5vw] tracking-[1.5px]">
                Filter and Sort
              </h4>
            </div>
            <h4>{products.length} products</h4>
          </div>
          <div className="flex flex-col w-full h-full px-[3vw] gap-[2vw] pb-[3vw] items-center">
            {products.map((product, index) => (
              <a href={`/products/${product.name}`}>
                ...
                >
                  <div className="relative overflow-hidden mb-[1vw]">
                    <img src={product.images[0]} alt="product_images" />
                  </div>
                  <div className="flex flex-col items-start w-full">
                    <h3 className="uppercase font-[font1] text-[6vw]">{product.name}</h3>
                    <div className="flex justify-between items-center w-full">
                      <h4 className="uppercase font-[font2] text-[3.5vw]">
                        eau de parfum
                      </h4>
                      <h4 className="font-[font2] text-[4vw] tracking-[1.5px]">
                        ₹ {product.price} | {product.bottleSize}
                      </h4>
                    </div>
                    <button
                      className="uppercase w-full font-[font3] text-[3vw] tracking-[1.5px] 
              border border-black py-[1vw] mt-[1.5vw]"
                    >
                      add to cart
                    </button>
                  </div>
                ...
                {products.map((product, index) => (
                  ...
                  transition-all duration-500 ease-in-out object-contain"
                      ...
                      <div className="flex flex-col items-start w-[30vw]">
                        <h3 className="uppercase font-[font1]">
                          {product.name}
                        </h3>
                        <div className="flex justify-between items-center w-full">
